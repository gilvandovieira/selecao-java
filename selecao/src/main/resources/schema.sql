create table if not exists sel_regiao
(
...
create table if not exists sel_revenda
(
    id        bigint generated by default as identity,
    cnpj      varchar(255),
    nome      varchar(255),
...
create table if not exists sel_transacao
(
    id                bigint generated by default as identity,
